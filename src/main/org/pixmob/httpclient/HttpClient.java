...
public class HttpClient {
    ...
    public HttpRequest get(String uri) {
        ...
        return new HttpRequest(this, uri, HTTP_GET);
    }
    ...
    public HttpRequest head(String uri) {
        ...
        return new HttpRequest(this, uri, HTTP_HEAD);
    }
    ...
    public HttpRequest post(String uri) {
        ...
        return new HttpRequest(this, uri, HTTP_POST);
    }
    ...
    public HttpRequest put(String uri) {
        ...
        return new HttpRequest(this, uri, HTTP_PUT);
    }
    ...
    public HttpRequest delete(String uri) {
        ...
        return new HttpRequest(this, uri, HTTP_DELETE);
    }
