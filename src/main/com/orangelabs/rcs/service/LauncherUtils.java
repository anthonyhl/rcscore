...
public class LauncherUtils {
	...
	public static void launchRcsService(Context context, boolean boot, boolean user) {
		...
		if (RcsSettings.getInstance().isServiceActivated()) {
			RcsCoreService.LaunchRcsStartService(context, boot, user);
		}
	}
    ...
    public static void launchRcsCoreService(Context context) {
        ...
        if (RcsSettings.getInstance().isServiceActivated()) {
        	if (RcsSettings.getInstance().isUserProfileConfigured()) {
        		...
        		RcsCoreService.startRcsCoreService(context);
	        } else {
		        if (logger.isActivated()) {
    ...
    public static void stopRcsService(Context context) {
        ...
        RcsCoreService.stopRcsCoreService(context);
    }
	...
	public static boolean isAccountChanged() {		
	    String lastUserAccount = getLastUserAccount(AndroidFactory.getApplicationContext());
	    String currentUserAccount = getCurrentUserAccount(AndroidFactory.getApplicationContext());
	
		return lastUserAccount != null && ((currentUserAccount == null) || !currentUserAccount.equalsIgnoreCase(lastUserAccount));
	}
}
