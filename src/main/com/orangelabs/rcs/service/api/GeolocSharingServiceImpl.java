...
import com.orangelabs.rcs.core.SessionIdGenerator;
...
import com.orangelabs.rcs.core.richcall.geoloc.GeolocSharingPersistedStorageAccessor;
...
public class GeolocSharingServiceImpl extends IGeolocSharingService.Stub {
    ...
    public IGeolocSharing shareGeoloc(ContactId contact, Geoloc geoloc) throws ServerApiException {
		...
		try {
			...
			String geolocDoc = ChatUtils.buildGeolocDocument(geoloc, mRichcallService.getUser().getPublicUri(), msgId);
