...
public class CapabilityServiceImpl extends ICapabilityService.Stub {
	...
	public void requestContactCapabilities(final ContactId contact) throws ServerApiException {
		...
		try {
			mOptionsExchangeRequestHandler.post(new CapabilitiesRequester(ImsModule.getInstance().getCapabilityService(), contact));
		} catch(Exception e) {
			if (logger.isActivated()) {
     ...
     */
    public void receiveCapabilities(ContactId contact, com.orangelabs.rcs.core.capability.Capabilities capabilities) {
    	synchronized(lock) {
    		if (logger.isActivated()) {
	...
	public void requestAllContactsCapabilities() throws ServerApiException {
		...
		try {
			mOptionsExchangeRequestHandler.post(new AllCapabilitiesRequester(ContactsManager.getInstance(), ImsModule
