...
public class DateUtils {
    ...
    /**
     * get the current time to string as <b>2014-09-26T11:21:00+8:00</b>
     * 
     * @return
     */
    public static String getUTCStringForCMCC() {
        Time time = new Time();
        time.setToNow();
        String string = time.format3339(false);
        String[] array = string.split(new String("\\."));
        array[1] = array[1].substring(3, array[1].length());

        return array[0] + array[1];
    }
    
    public static String currentTimeMillis() {
    	return encodeDate(System.currentTimeMillis());
    }
}
