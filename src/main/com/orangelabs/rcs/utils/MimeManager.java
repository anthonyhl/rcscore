...
public class MimeManager {
	...
	public static MimeManager getInstance() {
		if (instance == null) {
			...
			// audio type, refer to android MimeUtils.java and MediaFile.java
			instance.loadMap("m4a", "audio/mpeg");
			instance.loadMap("ogg", "audio/ogg");
			...
			// vCalendar, refer to android MimeUtils.java
			instance.loadMap("vcs", "text/x-vcalendar");
     ...
     * @param mime MIME type
     * @return Boolean
     * [@tct-stack] add by fang.wu@tcl.com
     */
    public static boolean isVCalenderType(String mime) {
        if (mime.toLowerCase().equalsIgnoreCase("text/x-vcalendar")) {
            return true;
        } else {
            return false;
        }
