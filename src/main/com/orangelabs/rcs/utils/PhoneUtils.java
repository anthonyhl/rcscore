...
public class PhoneUtils {
	 ...
	 * @return SIP URI
	 */
	public static String formatNumberToSipUri(String number, String homeDomain) {
		if (number == null) {
			return null;
		...
		try {
			...
			if (TEL_URI_SUPPORTED) {
				...
				return new StringBuilder(SIP_URI_HEADER).append(number).append("@")
						.append(homeDomain).append(";user=phone").toString();
	 ...
	 * @return the Uri
	 */
	public static String formatContactIdToUri(ContactId contactId, String homeDomain) {
		if (contactId == null) {
		...
		if (TEL_URI_SUPPORTED) {
			...
			// SIP-URI format
			return new StringBuilder(SIP_URI_HEADER).append(contactId).append("@").append(homeDomain)
