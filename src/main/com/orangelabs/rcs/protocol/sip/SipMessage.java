...
public abstract class SipMessage {
	 ...
	 * Min-SE header
	 */
	private static final String HEADER_MIN_SE = "Min-SE";
	...
	public void addHeader(String name, String value) {
		try {
			Header header = SipInterface.HEADER_FACTORY.createHeader(name, value);
	 ...
	 * @return Boolean
	 */
	public boolean isFeatureTagPresent(String featureTag) {
		boolean result = false;
		ArrayList<String> tags = getFeatureTags();
	...
	public int getMinExpires() {
		MinExpiresHeader minHeader = (MinExpiresHeader)getHeader(MinExpiresHeader.NAME);
		if (minHeader != null) {
	...
	public int getMinSessionExpirePeriod() {
		ExtensionHeader minSeHeader = (ExtensionHeader)getHeader(SipMessage.HEADER_MIN_SE);
		if (minSeHeader != null) {
