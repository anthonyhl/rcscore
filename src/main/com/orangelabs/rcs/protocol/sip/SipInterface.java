...
import com.orangelabs.rcs.protocol.sip.SipTransactionContext.INotifySipProvisionalResponse;
    ...
    */ 		
    ...
    public SipInterface(String localIpAddress, String proxyAddr,
        ...
        try {
            ...
            SipInterface.HEADER_FACTORY = sipFactory.createHeaderFactory();
            SipInterface.ADDR_FACTORY = sipFactory.createAddressFactory();
            SipInterface.MSG_FACTORY = sipFactory.createMessageFactory();
    ...
    private ClientTransaction createNewTransaction(SipRequest request) throws ParseException, NullPointerException, javax2.sip.SipException {
        ...
        if (ListeningPoint.UDP.equals(defaultProtocol) && this.tcpFallback
            ...
            if (topViaHeader != null) {
                ...
                topViaHeader = SipInterface.HEADER_FACTORY.createViaHeader(localIpAddress,
            ...
            if (topRouteHeader != null) {
                ...
                if (uri.isSipURI()) {
                    ...
                    topRouteHeader = SipInterface.HEADER_FACTORY.createRouteHeader(address);
                } else {
                    // TODO
    ...
    public ArrayList<ViaHeader> getViaHeaders() throws Exception {
        ...
        ViaHeader via = SipInterface.HEADER_FACTORY.createViaHeader(localIpAddress,
                listeningPort,
                getProxyProtocol(),
                null);
        viaHeaders.add(via);
    ...
    public ContactHeader getLocalContact() throws Exception {
        ...
        SipURI contactURI = (SipURI)SipInterface.ADDR_FACTORY.createSipURI(null, localIpAddress);
        contactURI.setPort(listeningPort);
        contactURI.setParameter("transport", defaultProtocol);
        
        // Create the Contact header
        Address contactAddress = SipInterface.ADDR_FACTORY.createAddress(contactURI);
        ContactHeader contactHeader = SipInterface.HEADER_FACTORY.createContactHeader(contactAddress);
    ...
    public ContactHeader getContact() throws Exception {
        ...
        if (publicGruu != null) {
            ...
            SipURI contactURI = (SipURI)SipInterface.ADDR_FACTORY.createSipURI(publicGruu);
            // Changed by Deutsche Telekom
            contactURI.setTransportParam(defaultProtocol);
            Address contactAddress = SipInterface.ADDR_FACTORY.createAddress(contactURI);
            contactHeader = SipInterface.HEADER_FACTORY.createContactHeader(contactAddress);
        } else
        if (instanceId != null) {
    ...
    public void sendSipCancel(SipDialogPath dialog) throws SipException {
        try {
            ...
            // Create the SIP request
            SipRequest cancel = dialog.createCancel();
    ...
    public void sendSipBye(SipDialogPath dialog) throws SipException {
        ...
        try {
            // Create the SIP request
            SipRequest bye = dialog.createBye();
    ...
    public SipTransactionContext sendSipUpdate(SipDialogPath dialog) throws SipException {
        ...
        try {
            // Create the SIP request
            SipRequest update = dialog.createUpdate();
