package com.orangelabs.rcs.protocol.sdp;
/*
...
public class SimpleSessionDescription {
    ...
    public static class Media extends Fields {
        ...
        public void setRtpPayload(int type, String rtpmap, String fmtp,
            ...
            super.set("a=fmtp:" + format, ' ', fmtp);
            if (width != 0 && height != 0) {
            	super.set("a=framesize:" + format, ' ', String.format("%d-%d", width, height));
            }
        }
        
        public void setExtMap(int id, String value) {
        	super.set("a=extmap:" + String.valueOf(id), ' ',value);
        }
