...
import com.orangelabs.rcs.protocol.presence.FavoriteLink;
import com.orangelabs.rcs.protocol.presence.Geoloc;
...
import com.orangelabs.rcs.service.AuthenticationService;
...
public final class ContactsManager {
	...
	public static void createInstance(Context ctx, LocalContentResolver localContentResolver) {
		if (sInstance != null) {
			return;
