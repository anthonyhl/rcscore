...
public interface IMessageLog {
    ...
    /**********************************************************************************
     *  tct-stack add for fix bug: don't send queued chat messages
     **********************************************************************************/

    /**
     * Get one to one specific status message ids
     * 
     * @param contact
     * @param direction
     * @param status
    ...
    /**
     * Get group specific status message ids
     * 
     * @param chatId
     * @param direction
     * @param status
    ...
    /**
     * Get one to one chat conversation id
     * 
     * @param contact
     * @return
     */
    String getOneToOneChatConversationId(ContactId contact);
