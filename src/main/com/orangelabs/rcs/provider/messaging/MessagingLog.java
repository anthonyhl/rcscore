...
public class MessagingLog implements IGroupChatLog, IMessageLog, IFileTransferLog, IGroupDeliveryInfoLog {
	 ...
	 * (java.lang.String,
	 * com.orangelabs.rcs.core.service.im.chat.ChatMessage, int, int, int)
	 */
	@Override
	...
	public void deleteAllEntries() {
		mLocalContentResolver.delete(GroupChatLog.CONTENT_URI, null, null);
		mLocalContentResolver.delete(ChatLog.Message.CONTENT_URI, null, null);
		mLocalContentResolver.delete(FileTransferLog.CONTENT_URI, null, null);
    ...
    /**********************************************************************************
     *  tct-stack add for fix bug: don't send queued message and file transfer
     **********************************************************************************/

    /*
     * (non-Javadoc)
     * @see com.orangelabs.rcs.provider.messaging.IMessageLog#getOneToOneChatMessages (ContactId, int, int, int)
     */
    @Override
    public Set<String> getOneToOneChatMessageIds(ContactId contact, int direction, int status, int reasonCode) {
        return messageLog.getOneToOneChatMessageIds(contact, direction, status, reasonCode);
    }

    /*
     * (non-Javadoc)
     * @see com.orangelabs.rcs.provider.messaging.IMessageLog#getGroupChatMessageIds (String, int, int, int)
     */
    @Override
    public Set<String> getGroupChatMessageIds(String chatId, int direction, int status, int reasonCode) {
        return messageLog.getGroupChatMessageIds(chatId, direction, status, reasonCode);
    }

    /*
     * (non-Javadoc)
     * @see com.orangelabs.rcs.provider.messaging.IFileTransferLog#getAllFileTransferIds(int, int, int)
     */
    @Override
    public Set<String> getAllFileTransferIds(int direction, int state, int reasonCode) {
        return fileTransferLog.getAllFileTransferIds(direction, state, reasonCode);
    }

    /*
     * (non-Javadoc)
     * @see com.orangelabs.rcs.provider.messaging.IFileTransferLog#getGroupFileTransferIds(java.lang.String, int, int, int)
     */
    public Set<String> getGroupFileTransferIds(String chatId, int direction, int state, int reasonCode) {
        return fileTransferLog.getGroupFileTransferIds(chatId, direction, state, reasonCode);
    }
    ...
    public boolean isGroupChatConversation(String chatId) {
        return groupChatLog.isGroupChatConversation(chatId);
    }
    ...
    public void addFileTransferExt(String fileTransferId, String convId, ContactId contact, int direction,
        ...
        fileTransferLog.addFileTransferExt(fileTransferId, convId, contact, direction, content, fileIcon, state,
                reasonCode);
    }

    @Override
    public String getOneToOneChatConversationId(ContactId contact) {
        return messageLog.getOneToOneChatConversationId(contact);
    }
