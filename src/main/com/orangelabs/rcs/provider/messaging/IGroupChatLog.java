...
public interface IGroupChatLog {
	...
	/**
     * Is a group chat conversation
     * 
     * @param chatId Chat ID / Conversation Id / Contribution Id
     * @return true if it is a group chat conversation
     */
    boolean isGroupChatConversation(String chatId);
