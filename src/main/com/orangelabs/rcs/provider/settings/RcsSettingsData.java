...
public class RcsSettingsData {
	...
	public enum AuthenticationProcedure {
		...
		DIGEST,
		/**
		 * Special authentication with IMSI instead of MSISDN
		 */
		IMSI_DIGEST,
	};
	...
	/* package private */static final Boolean DEFAULT_SIP_TRACE_ACTIVATED = true;
	...
	/* package private */static final Boolean DEFAULT_MEDIA_TRACE_ACTIVATED = true;
	...
	/**
	 * the public account server access address
	 */
	public static final String PUBLICACCOUNT_ACCESS_ADDRESS = "access_address";
    /* package private */static final String DEFAULT_PUBLICACCOUNT_ACCESS_ADDRESS = "http://60.194.14.154:81/interface/index.php";
}
