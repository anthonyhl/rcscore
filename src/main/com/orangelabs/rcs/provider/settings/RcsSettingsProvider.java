...
public class RcsSettingsProvider extends ContentProvider {
    ...
    private static final String RESTRICTED_SELECTION_QUERY_FOR_EXTERNALLY_DEFINED_COLUMNS = new StringBuilder(
            ...
            .append(RcsSettingsData.KEY_DEFAULT_MESSAGING_METHOD).append("','")
            // @tct-stack add begin
            .append(RcsSettingsData.SMS_FALLBACK_SERVICE).append("','")
            .append(RcsSettingsData.AUTO_ACCEPT_FILE_TRANSFER).append("','")
            .append(RcsSettingsData.AUTO_ACCEPT_CHAT).append("','")
            .append(RcsSettingsData.AUTO_ACCEPT_GROUP_CHAT).append("','")
            .append(RcsSettingsData.WARN_SF_SERVICE).append("')")
            // @tct-stack add end
            .toString();
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
			...
			addParameter(db, RcsSettingsData.PUBLICACCOUNT_ACCESS_ADDRESS, RcsSettingsData.DEFAULT_PUBLICACCOUNT_ACCESS_ADDRESS);
        }
