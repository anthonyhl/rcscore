...
public class AndroidRegistryFactory extends RegistryFactory {
     ...
     */
    public void setNewUserAccount(boolean value) {
    	writeBoolean(REGISTRY_NEW_USER_ACCOUNT, value);
    }
     ...
     */
    public boolean getNewUserAccount() {    
        return readBoolean(REGISTRY_NEW_USER_ACCOUNT, false);
    }
}
