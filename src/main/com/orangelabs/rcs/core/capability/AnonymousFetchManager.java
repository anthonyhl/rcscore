...
import com.orangelabs.rcs.protocol.presence.PresenceInfo;
import com.orangelabs.rcs.protocol.presence.PresenceUtils;
import com.orangelabs.rcs.protocol.presence.pidf.PidfDocument;
import com.orangelabs.rcs.protocol.presence.pidf.PidfParser;
import com.orangelabs.rcs.protocol.presence.pidf.Tuple;
	    ...
	    if (content != null) {
	    	...
	    	try {
		    	...
		    	if (presence == null) {
		    		...
		    		// Notify listener
		    		imsModule.getListener().handleCapabilitiesNotification(contact, capabilities);
			...
			try {
				...
				ContactId contact = ContactUtils.createContactId(notify.getAssertedIdentity());
