...
import com.orangelabs.rcs.core.ImsSessionBasedServiceError;
import com.orangelabs.rcs.core.content.AudioContent;
import com.orangelabs.rcs.core.content.ContentManager;
import com.orangelabs.rcs.core.content.VideoContent;
import com.orangelabs.rcs.core.richcall.video.SdpOrientationExtension;
...
public abstract class IPCallSession extends ImsServiceSession {
	...
	public IPCallSession(ImsService imsService, ContactId contact, AudioContent audioContent, VideoContent videoContent) {
		super(imsService, contact, PhoneUtils.formatContactIdToUri(contact, imsService.getUser().getHomeDomain()));
	...
	public SipRequest createInvite() throws SipException {
		return getDialogPath().createInvite(null, null, getDialogPath().getLocalContent());
	}
