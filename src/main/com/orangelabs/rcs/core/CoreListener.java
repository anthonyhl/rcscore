 ...
 */
public interface CoreListener extends RegistrationListener {
    /**
    ...
    /** 
     * Queued specific group file transfers can be sent now
     * 
     * @param chatId is group unique chatId
     */
    ...
    /**
     * New one-to-one chat large mode session invitation
     * 
     * @param session Chat session
     */
    ...
    /**
     * New one-to-one chat pager mode session message
     * 
     * @param session Chat session
     */
