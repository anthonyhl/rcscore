...
import com.orangelabs.rcs.core.im.chat.resourcelist.ResourceListDocument;
import com.orangelabs.rcs.core.im.chat.resourcelist.ResourceListParser;
...
public class ParticipantInfoUtils {
	 ...
	 */
	public static Set<ParticipantInfo> parseResourceList(String xml, ContactId self) {
