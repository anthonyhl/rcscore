...
public class ChatMessage {
    ...
    private String mConversationId; // final is better
     ...
     * @param displayName the name to display
     */
    public ChatMessage(String msgId, String convId, ContactId remote, String content, String mimeType, Date serverReceiptAt, String displayName) {
        mMsgId = msgId;
