...
public abstract class OneToOneChatSession extends ChatSession {
	...
	public void sendChatMessage(ChatMessage msg) {
		...
		if (useImdn) {
			networkContent = ChatUtils.buildCpimMessageWithImdn(from, to, msgId,
					msg.getContent(), mimeType, getImsService().getUser().getHomeDomain());
	...
	private SipRequest createMultipartInviteRequest(String content)
			throws SipException {
		SipRequest invite = SipUtils.createMultipartInvite(getDialogPath(),
	...
	private SipRequest createInviteRequest(String content) throws SipException {
		String[] featureTags = InstantMessagingService.CHAT_FEATURE_TAGS;
		SipRequest invite = getDialogPath().createInvite(featureTags, featureTags, content);
	 ...
	 *
	 * @return Direction
	 * @see com.orangelabs.rcs.protocol.sdp.SdpUtils#DIRECTION_RECVONLY
	 * @see com.orangelabs.rcs.protocol.sdp.SdpUtils#DIRECTION_SENDONLY
	 * @see com.orangelabs.rcs.protocol.sdp.SdpUtils#DIRECTION_SENDRECV
	 */
	 ...
	 * (non-Javadoc)
	 * @see
	 * com.orangelabs.rcs.core.service.im.chat.ChatSession#msrpTransferError
	 * (java.lang.String, java.lang.String,
	 * com.orangelabs.rcs.core.protocol.msrp.MsrpSession.TypeMsrpChunk)
	 */
	@Override
