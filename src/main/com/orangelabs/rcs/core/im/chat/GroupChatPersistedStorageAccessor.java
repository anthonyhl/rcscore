...
public class GroupChatPersistedStorageAccessor {
	...
	public Set<String> getGroupChatMessageIds(int direction, int status, int reasonCode) {
	    return mMessagingLog.getGroupChatMessageIds(mChatId, direction, status, reasonCode);
	}
