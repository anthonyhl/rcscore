...
public abstract class ImsFileSharingSession extends FileSharingSession {
	...
	public ImsFileSharingSession(ImsService parent, MmContent content, ContactId contact, MmContent fileIcon, String filetransferId) {
		super(parent, content, contact, PhoneUtils.formatContactIdToUri(contact, parent.getUser().getHomeDomain()), fileIcon, filetransferId);
	}
    ...
    /**********************************************************************************
     *  tct-stack add for CMCC message modes: OTM large mode ft
     **********************************************************************************/
     ...
     * @param filetransferId File transfer Id
     */
    public ImsFileSharingSession(ImsService parent, String remoteUri, MmContent content, ContactId contact, MmContent fileIcon, String filetransferId) {
