...
public class FileTransferPersistedStorageAccessor {
    ...
    /**********************************************************************************
     *  tct-stack add for CMCC message modes: ft large mode
     **********************************************************************************/

    public void addFileTransferExt(String convId, ContactId contact, int direction, MmContent content,
            MmContent fileIcon, int status, int reasonCode) {
        mMessagingLog.addFileTransferExt(mFileTransferId, convId, contact, direction, content, fileIcon,
                status, reasonCode);
    }
