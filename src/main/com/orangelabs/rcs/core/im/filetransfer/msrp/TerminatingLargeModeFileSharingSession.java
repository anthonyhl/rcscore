...
import com.orangelabs.rcs.protocol.msrp.MsrpConstants;
 ...
 * @author jexa7410
 */
public class TerminatingLargeModeFileSharingSession extends ImsFileSharingSession implements MsrpEventListener {
	/**
	 * MSRP manager
	 */
     ...
     * The logger
     */
    private static final Logger logger = Logger.getLogger(TerminatingLargeModeFileSharingSession.class.getSimpleName());
	 ...
	 */
	public TerminatingLargeModeFileSharingSession(ImsService parent, SipRequest invite) throws RcsContactFormatException {
		super(parent, ContentManager.createMmContentFromSdp(invite), ContactUtils.createContactId(invite.getAssertedIdentity()), FileTransferUtils.extractFileIcon(invite), IdGenerator.generateMessageID());
	...
	public void run() {
		try {
			...
			String[] featureTags = InstantMessagingService.FT_FEATURE_TAGS;
