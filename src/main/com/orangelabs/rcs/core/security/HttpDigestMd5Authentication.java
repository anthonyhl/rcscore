...
package com.orangelabs.rcs.core.security;
...
public class HttpDigestMd5Authentication {
	...
	public String genDigestAuth(String method, String requestUri, String body, String serverLogin, String serverPwd)
			throws Exception {
		...
		if ((qop != null) && qop.startsWith("auth")) {	
			...
			// Calculate response
			response = calculateResponse(serverLogin, serverPwd,
					method,
					requestUri,
					buildNonceCounter(),
					body);	
