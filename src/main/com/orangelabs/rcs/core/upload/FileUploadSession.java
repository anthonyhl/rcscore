 ...
 ******************************************************************************/
package com.orangelabs.rcs.core.upload;
...
import com.orangelabs.rcs.core.im.filetransfer.http.HttpUploadManager;
import com.orangelabs.rcs.core.im.filetransfer.http.HttpUploadTransferEventListener;
...
public class FileUploadSession extends Thread implements HttpUploadTransferEventListener {
	...
	public void startSession() {
		ImsModule.getInstance().getInstantMessagingService().addSession(this);
		start();
	}

	public void removeSession() {
		ImsModule.getInstance().getInstantMessagingService().removeSession(this);
	}
}
