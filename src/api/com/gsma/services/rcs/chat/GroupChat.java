...
public class GroupChat {
     ...
     * @throws RcsServiceException
     */
    public ChatMessage sendMessage(Mcloud mcloud) throws RcsServiceException {
        try {
            return new ChatMessage(mGroupChatInf.sendMcloudMessage(mcloud));
        } catch(Exception e) {
            throw new RcsServiceException(e.getMessage());
        }       
    }
     ...
     * 
     * @param mcloud Vemoticon
     * @return ChatMessage
     * @throws RcsServiceException
     */
    public ChatMessage sendMessage(Vemoticon vemoticon) throws RcsServiceException {
        try {
            return new ChatMessage(mGroupChatInf.sendVemoticonMessage(vemoticon));
        } catch(Exception e) {
            throw new RcsServiceException(e.getMessage());
        }       
    }
    ...
    /**
     * set the group chat's chairman's info
     * 
     * @param contact chairman's info
     */
    public void setChairman(ContactId contact) {
        // TODO
    }

    /**
     * if current contact is the group chat's chairman
     */
