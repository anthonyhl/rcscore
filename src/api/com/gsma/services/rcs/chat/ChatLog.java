...
public class ChatLog {
		...
		public static Set<ParticipantInfo> getParticipantInfo(Context context, String participants) {
			...
			for (String participant : tokens) {
				...
				if (keyValue.length == 2) {
					...
					//TODO tct-stack modified to normalizeNumber
					result.add(new ParticipantInfo(contactUtils.normalizeNumber(contact), status));
				}
			}
			return result;
		}
    ...
    public static class Message {
         ...
         */
    	public static final Uri AUTHORITY = Uri.parse("content://com.gsma.services.rcs.provider.chat");
        public static final Uri CONTENT_URI = Uri.withAppendedPath(AUTHORITY, "chatmessage");
        
        public static final Uri THREAD_URI = Uri.withAppendedPath(AUTHORITY, "threads");
        public static final Uri THREAD_COUNT_URI = Uri.withAppendedPath(THREAD_URI, "count");
        
        public static final Uri MESSAGE_URI = Uri.withAppendedPath(AUTHORITY, "all");

        public static final String MESSAGE_TYPE = "message_type"; // 1 for chat, 2 for ft

        public static final Uri MESSAGE_URI_SEARCH = Uri.withAppendedPath(AUTHORITY, "search");
